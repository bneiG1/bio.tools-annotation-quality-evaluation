...
class CompletenessScorer:
    ...
    def _load_default_config(self) -> Dict:
        ...
        return {
            ...
            'field_weights': {
                'name': 3, 'description': 5, 'homepage': 3, 'biotoolsID': 2,
                'version': 5, 'function': 5, 'topic': 5, 'operation': 5,
                'toolType': 4, 'language': 3, 'operatingSystem': 3,
                'license': 4, 'documentation': 6, 'publication': 8,
                'download': 5, 'contact': 6, 'credit': 4
            },
            'tiers': {
    ...
    def load_config(self, config_path: str):
        ...
        try:
            ...
            if 'scoring' in config:
                self.config.update(config['scoring'])
    ...
    def score_accessibility(self, tool_data: Dict) -> Tuple[float, Dict[str, Any]]:
        ...
        total_score = (download_score + link_score + repository_score) / 10 * max_score
    ...
    def score_community(self, tool_data: Dict) -> Tuple[float, Dict[str, Any]]:
        ...
        Returns:
            Tuple of (score, details)
        """
        max_score = self.config['weights']['community']
